...
new_bins <- seq(60, 180, 10) # bins to be used in the clustering analysis
...
```{r}
# setwd("D:/OneDrive - IATTC/Git/FishFreqClustering/")
teststat <- heterodist(alydens.spatial23$merges,alydens.spatial23$distseq,new_bins,densmaty,
                       sign(rrs),doko=c(1,20),BB=100,bins = seq(60, 180, 10)/100)
