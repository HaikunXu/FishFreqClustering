...
LF <- LF.DEL[, c("year", "quarter", "lat", "lon", paste0("X", 1:201))] %>%
  ...
  filter(N > 11) # remove the cells with less than 4 quarters of data since 2000
...
lines(21:160,weightvec/mean(weightvec))
...
final_nodes <- find_clusters(MJS_statistics, distance_threshold = 5, catch_threshold = 0)
