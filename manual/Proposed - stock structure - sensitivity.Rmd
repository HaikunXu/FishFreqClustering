---
title: "New areas for YFT in dolphin sets"
author: "Haikun Xu"
date: "`r Sys.Date()`"
...
lines(61:200,weightvec/mean(weightvec))
...
final_nodes <- find_clusters(MJS_statistics, distance_threshold = 5, catch_threshold = 0.05)
...
densy_df <- clusthistd3(kk = 3, colseq = temp2 + 1, colcol, plot = FALSE)
