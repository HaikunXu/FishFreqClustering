...
cplotu(alydens.spatial23$merges, alydens.spatial23$distseq, hopt = 'unit')
...
temp2 <- rep(1, 67)
temp2[teststat$childnodes[58][[1]]] <- 2
temp2[teststat$childnodes[63][[1]]] <- 3
temp2[teststat$childnodes[51][[1]]] <- 4
...
atitle.cl<-"2000-2023"
clusthistd3(kk=5,colseq=temp2+1,atitle.cl,colcol,xlims = c(0,2), ylims = c(0,2.5))
```